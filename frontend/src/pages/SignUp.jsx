...
const SignUp = () => {
  ...
  return (
    <div className='w-full h-[100vh] bg-cover flex justify-center items-center' style={{backgroundImage:`url(${bg})`}}>
     <form className='w-[80%] h-[500px] max-w-[500px] px-[20px] bg-[#0000003b]
      backdrop-blur shadow-lg shadow-black flex flex-col items-center
      justify-center gap-[20px]' onSubmit={handleSignUp}
     >
      ...
      h-[60px] px-[20px] py-[10px] rounded-full text-[18px] outline-none border-2 border-white bg-transparent text-white placeholder-gray-300' required onChange={(e)=>setName(e.target.value)} value={name}/>
     ...
     <button className='min-w-[148px] h-[58px] bg-white cursor-pointer rounded-full mt-[10px] text-black font-semibold text-[19px]' disabled={loading}>{loading?"Loading....":"SignUp"}</button>
